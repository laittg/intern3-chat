...
export const ChatActions = memo(
  ({ message, onRetry, onEdit, onCopy }: ChatActionsProps) => {
    ...
    return (
      <div className="absolute right-0 mt-3 flex items-center gap-1 opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100 group-focus:opacity-100 group-hover:visible group-focus:visible group-hover:z-10 group-focus:z-10">
        {onRetry && (
